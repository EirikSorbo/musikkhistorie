...
//  «genre-model.js» og «genre-model.js?v=4.60» som TO moduler med hver sin
//  tilstand, og da ville hjelperen fylt en kopi ingen leser. bump.sh holder
//  suffikset i synk (den dekker tests/*/*.js).
// ============================================================================
import { GENEALOGY, FAMILIES, META_ORDER_HINT } from "../../js/genealogy-data.js?v=4.60";
import { rebuild } from "../../js/genre-model.js?v=4.60";
