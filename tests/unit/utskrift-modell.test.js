...
} from "../../js/utskrift-modell.js?v=5.71";
import { isVisible } from "../../js/limits.js?v=5.71";
import { GENEALOGY_ROOT_GENRES, GENEALOGY_META_GENRES } from "../../js/genre-model.js?v=5.71";
...
const ARTISTER = [
  { id: "bessie", name: "Bessie Smith", status: "active", priority: 3, metaGenre: "Blues", instrument: "Vokal",
    ...
    musicExamples: [{ label: "St. Louis Blues", url: "https://www.youtube.com/watch?v=5.71rd9IaA_uJI", year: 1925 }],
