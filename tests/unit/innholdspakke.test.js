...
import { STORY_ORDER } from "../../js/story-format.js?v=5.19";
import { renderRichText } from "../../js/rich-text.js?v=5.19";
import { GENEALOGY_MAIN_GENRES } from "../../js/genre-model.js?v=5.19";
