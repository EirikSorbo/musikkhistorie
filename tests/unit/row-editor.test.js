...
import { rowInnerHtml, normalizeSources, WORK_SPEC, MUSIC_SPEC, SOURCE_SPEC, musicSpecWithGenres } from "../../js/row-editor.js?v=5.13";
import { KILDE_KATEGORIER } from "../../js/kilder.js?v=5.13";
