...
import { GENEALOGY as SEED_NODES, FAMILIES as SEED_FAMILIES, META_ORDER_HINT } from "../../js/genealogy-data.js?v=5.70";
import { byggGenealogyDoc } from "../../tools/build-genealogy-doc.js";
import { computeColumns, LAYOUT_WIDTH } from "../../js/genre-layout.js?v=5.70";
