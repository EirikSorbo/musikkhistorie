...
} from "../../js/limits.js?v=3.82";
import { instrumentInnovations, buildInstrumentTimeline } from "../../js/ui-timeline.js?v=3.82";
import { PROPOSABLE_KEYS } from "../../js/proposal-fields.js?v=3.82";
...
test("instrumentPageId gir lovlige, stabile Firestore-ID-er", async () => {
  const { instrumentPageId } = await import("../../js/limits.js?v=3.82");
