...
import { storyOrder, STORY_SKJULT } from "../../js/story-format.js?v=5.23";
import { periodGroups, periodAxis, pctAv, periodColor, periodSignatur, PERIOD_COLORS } from "../../js/genre-periods.js?v=5.23";
