...
import { contentGaps } from "../../js/ui-dashboard.js?v=5.36";
import { GENEALOGY_EDGES, edgeKey } from "../../js/genre-model.js?v=5.36";
...
test("side med kilder men uten tekst teller som hull", async () => {
  const { contentGaps } = await import("../../js/ui-dashboard.js?v=5.36");
