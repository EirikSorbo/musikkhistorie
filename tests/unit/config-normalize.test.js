...
import { normalizeConfig } from "../../js/config-normalize.js?v=2.88";
import { GENEALOGY_META_GENRES } from "../../js/genealogy.js?v=2.88";
import { META_RENAME } from "../../js/artist-normalize.js?v=2.88";
