...
import { resolveDesc, resolveDescAny, missingDesc } from "../../js/genre-descriptions.js?v=4.43";
import { GENEALOGY, resolveMainDesc } from "../../js/genealogy.js?v=4.43";
...
test("eraText: Firestore-årstall vinner, tomt sluttår blir «i dag», ellers node-fallback", async () => {
  const { eraText } = await import("../../js/genealogy.js?v=4.43");
