...
import { resolveDesc, resolveDescAny, missingDesc } from "../../js/genre-descriptions.js?v=4.91";
import { resolveMainDesc } from "../../js/genealogy.js?v=4.91";
import { GENEALOGY } from "../../js/genre-model.js?v=4.91";
...
test("eraText: årstall vinner, tomt sluttår blir «i dag», ellers fritekst-epoken", async () => {
  const { eraText } = await import("../../js/genealogy.js?v=4.91");
...
test("eraLine: sjangerkortet viser årstallene OG epoke-friteksten", async () => {
  const { eraLine } = await import("../../js/genealogy.js?v=4.91");
