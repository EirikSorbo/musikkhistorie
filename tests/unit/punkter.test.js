...
import { normaliserPunkter, lesPunkter, punkterTilTekst, punktVarsel, punkterHtml, PUNKT_MAKS_ANTALL, PUNKT_MAKS_TEGN } from "../../js/punkter.js?v=5.70";
import { normalizeArtist, buildArtistDoc } from "../../js/artist-normalize.js?v=5.70";
import { PROPOSABLE_KEYS } from "../../js/proposal-fields.js?v=5.70";
import { ARTIST_EXPORT_FIELDS, ARTIST_COMPARE_FIELDS, ARTIST_LABELS } from "../../js/artist-schema.js?v=5.70";
import { resolveDesc } from "../../js/genre-descriptions.js?v=5.70";
import { validateArtistsForImport } from "../../js/import-format.js?v=5.70";
...
test("delposter (v5.51): navn + punkter er en delpost, et ekte kort er det ikke", async () => {
  const { erDelpost } = await import("../../js/import-format.js?v=5.70");
