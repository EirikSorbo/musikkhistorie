...
import { DECADES } from "./limits.js?v=5.17";
import { opts, getState, onMainGenreClick } from "./explore-context.js?v=5.17";
import { heatRow, heatStripHtml, heatAxisHtml } from "./heat-strip.js?v=5.17";
