...
import { escapeHtml, modalOpen, modalClose } from "./ui.js?v=5.32";
import { DECADES } from "./limits.js?v=5.32";
import { opts, getState, onMainGenreClick } from "./explore-context.js?v=5.32";
import { heatRow, heatStripHtml, heatAxisHtml } from "./heat-strip.js?v=5.32";
