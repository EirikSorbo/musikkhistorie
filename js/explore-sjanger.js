...
import { isMainGenre, GENEALOGY_MAIN_GENRES, canonMainGenre } from "./genre-model.js?v=4.96";
import { resolveDesc, missingDesc } from "./genre-descriptions.js?v=4.96";
import { opts, getState, injectTeacherRow } from "./explore-context.js?v=4.96";
