...
import { isMainGenre, GENEALOGY_MAIN_GENRES, canonMainGenre } from "./genre-model.js?v=5.68";
import { resolveDesc, missingDesc } from "./genre-descriptions.js?v=5.68";
import { opts, getState, injectTeacherRow } from "./explore-context.js?v=5.68";
