...
// ============================================================================
import { escapeHtml, modalOpen, modalClose } from "./ui.js?v=3.73";
import { isVisible } from "./limits.js?v=3.73";
import { isMainGenre, GENEALOGY_MAIN_GENRES } from "./genealogy.js?v=3.73";
import { resolveDesc, missingDesc } from "./genre-descriptions.js?v=3.73";
import { opts, getState, canonMain, injectTeacherRow } from "./explore-context.js?v=3.73";
