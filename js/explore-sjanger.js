...
// ============================================================================
import { escapeHtml, modalOpen, modalClose } from "./ui.js?v=3.82";
import { isVisible } from "./limits.js?v=3.82";
import { isMainGenre, GENEALOGY_MAIN_GENRES } from "./genealogy.js?v=3.82";
import { resolveDesc, missingDesc } from "./genre-descriptions.js?v=3.82";
import { opts, getState, canonMain, injectTeacherRow } from "./explore-context.js?v=3.82";
