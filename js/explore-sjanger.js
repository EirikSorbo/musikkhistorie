...
// ============================================================================
import { escapeHtml, modalOpen, modalClose } from "./ui.js?v=5.45";
import { isVisible } from "./limits.js?v=5.45";
import { isMainGenre, GENEALOGY_MAIN_GENRES, canonMainGenre } from "./genre-model.js?v=5.45";
import { resolveDesc, missingDesc } from "./genre-descriptions.js?v=5.45";
import { opts, getState, injectTeacherRow } from "./explore-context.js?v=5.45";
