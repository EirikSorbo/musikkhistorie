...
import {
  ...
  DECADES,
  INSTRUMENTS,
} from "./limits.js?v=5.11";
import { escapeHtml, GENDER_LABEL, pct, teacherActionRow, toggleCheckBtn, PRIO_ICONS, PRIO_LABELS } from "./ui-helpers.js?v=5.11";
import { GENEALOGY, GENEALOGY_MAIN_GENRES, GENEALOGY_META_GENRES, GENEALOGY_EDGES, edgeKey, isMainGenre } from "./genre-model.js?v=5.11";
import { resolveDesc, resolveDescAny } from "./genre-descriptions.js?v=5.11";
