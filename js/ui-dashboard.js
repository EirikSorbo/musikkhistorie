...
import {
  ...
  limitForMetaGenre,
  limitForInstrument,
} from "./limits.js?v=3.2";
import { escapeHtml, GENDER_LABEL, pct } from "./ui-helpers.js?v=3.2";
import { GENEALOGY, isMainGenre } from "./genealogy.js?v=3.2";
import { resolveDesc, resolveDescAny } from "./genre-descriptions.js?v=3.2";
