...
import {
  ...
  limitForMetaGenre,
  limitForInstrument,
} from "./limits.js?v=3.7";
import { escapeHtml, GENDER_LABEL, pct } from "./ui-helpers.js?v=3.7";
import { GENEALOGY, isMainGenre } from "./genealogy.js?v=3.7";
import { resolveDesc, resolveDescAny } from "./genre-descriptions.js?v=3.7";
