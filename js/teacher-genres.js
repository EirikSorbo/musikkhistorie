...
import { escapeHtml, kanoniskJson } from "./util.js?v=5.65";
import { modalOpen, modalClose } from "./ui.js?v=5.65";
import { state } from "./teacher-state.js?v=5.65";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=5.65";
...
} from "./genre-migrate.js?v=5.65";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=5.65";
