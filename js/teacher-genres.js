...
import { modalOpen, modalClose } from "./ui.js?v=4.95";
import { state, guardTeacherAction } from "./teacher-state.js?v=4.95";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=4.95";
...
} from "./genre-migrate.js?v=4.95";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=4.95";
