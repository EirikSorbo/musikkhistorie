...
import { modalOpen, modalClose } from "./ui.js?v=5.28";
import { state } from "./teacher-state.js?v=5.28";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=5.28";
import { validateTree } from "./genre-validate.js?v=5.28";
import {
...
} from "./genre-migrate.js?v=5.28";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=5.28";
