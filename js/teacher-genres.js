...
import { escapeHtml, kanoniskJson } from "./util.js?v=5.57";
import { modalOpen, modalClose } from "./ui.js?v=5.57";
import { state } from "./teacher-state.js?v=5.57";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=5.57";
...
} from "./genre-migrate.js?v=5.57";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=5.57";
