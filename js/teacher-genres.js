...
import { modalOpen, modalClose } from "./ui.js?v=5.04";
import { state, guardTeacherAction } from "./teacher-state.js?v=5.04";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=5.04";
...
} from "./genre-migrate.js?v=5.04";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=5.04";
