...
import { modalOpen, modalClose } from "./ui.js?v=5.07";
import { state, guardTeacherAction } from "./teacher-state.js?v=5.07";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=5.07";
...
} from "./genre-migrate.js?v=5.07";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=5.07";
