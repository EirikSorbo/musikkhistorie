...
import { modalOpen, modalClose } from "./ui.js?v=5.05";
import { state, guardTeacherAction } from "./teacher-state.js?v=5.05";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=5.05";
...
} from "./genre-migrate.js?v=5.05";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=5.05";
