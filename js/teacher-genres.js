...
import { modalOpen, modalClose } from "./ui.js?v=5.01";
import { state, guardTeacherAction } from "./teacher-state.js?v=5.01";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=5.01";
...
} from "./genre-migrate.js?v=5.01";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=5.01";
