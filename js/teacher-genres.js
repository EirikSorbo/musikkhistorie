...
import { modalOpen, modalClose } from "./ui.js?v=5.24";
import { state } from "./teacher-state.js?v=5.24";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=5.24";
...
} from "./genre-migrate.js?v=5.24";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=5.24";
