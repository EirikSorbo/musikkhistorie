...
import { modalOpen, modalClose } from "./ui.js?v=4.86";
import { state, guardTeacherAction } from "./teacher-state.js?v=4.86";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=4.86";
...
} from "./genre-migrate.js?v=4.86";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=4.86";
