...
import { modalOpen, modalClose } from "./ui.js?v=5.11";
import { state, guardTeacherAction } from "./teacher-state.js?v=5.11";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=5.11";
import { validateTree } from "./genre-validate.js?v=5.11";
import {
...
} from "./genre-migrate.js?v=5.11";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=5.11";
