...
import { escapeHtml } from "./util.js?v=5.20";
import { modalOpen, modalClose } from "./ui.js?v=5.20";
import { state } from "./teacher-state.js?v=5.20";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=5.20";
import { validateTree } from "./genre-validate.js?v=5.20";
import {
...
} from "./genre-migrate.js?v=5.20";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=5.20";
