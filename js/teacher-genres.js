...
import { escapeHtml, kanoniskJson } from "./util.js?v=5.50";
import { modalOpen, modalClose } from "./ui.js?v=5.50";
import { state } from "./teacher-state.js?v=5.50";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=5.50";
...
} from "./genre-migrate.js?v=5.50";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=5.50";
