...
import { escapeHtml, kanoniskJson } from "./util.js?v=5.48";
import { modalOpen, modalClose } from "./ui.js?v=5.48";
import { state } from "./teacher-state.js?v=5.48";
import { DECADE_ROWS, FAMILIES } from "./genre-model.js?v=5.48";
...
} from "./genre-migrate.js?v=5.48";
import { runMigrationPlan, saveGenealogyTree } from "./store.js?v=5.48";
...
function renderListe() {
  ...
  if (ryddHeat) {
    ...
    // Samme predikat som planen (heatOrphanKeys) — tidligere hadde de hver sin
    // kopi, og knappen kunne love å slette noe planen ikke skulle rørt.
    const foreldrelose = heatOrphanKeys(t.nodes, heat);
