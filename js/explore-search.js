...
import { modalOpen, escapeHtml, showSubsjangerInfo } from "./ui.js?v=4.94";
import { SKJUL_I_STUDENTVISNING } from "./feature-flags.js?v=4.94";
import { showEdgeInfo } from "./genealogy.js?v=4.94";
import { byggIndeks, sok, utdrag, marker } from "./search.js?v=4.94";
...
const PER_GRUPPE = 6;
import { opts, getState, onMainGenreClick, sjangerOpts } from "./explore-context.js?v=4.94";
import { openTechDetail } from "./explore-tech.js?v=4.94";
import { openDecade } from "./explore-decade.js?v=4.94";
import { openRotter, openOmHistorie, openHistorier, openAppGuide } from "./explore-innhold.js?v=4.94";
import { openInstrumenter } from "./explore-instrument.js?v=4.94";
