...
import { byggIndeks, sok, utdrag, marker } from "./search.js?v=5.28";
import { getState } from "./explore-context.js?v=5.28";
import { apneMaal } from "./explore-apne.js?v=5.28";
import { erSkrivefelt, erSokHurtigtast } from "./vis-lenke.js?v=5.28";
