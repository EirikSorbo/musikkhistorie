...
import { modalOpen, escapeHtml, showSubsjangerInfo } from "./ui.js?v=4.99";
import { SKJUL_I_STUDENTVISNING } from "./feature-flags.js?v=4.99";
import { showEdgeInfo } from "./genealogy.js?v=4.99";
import { byggIndeks, sok, utdrag, marker } from "./search.js?v=4.99";
...
const PER_GRUPPE = 6;
import { opts, getState, onMainGenreClick, sjangerOpts } from "./explore-context.js?v=4.99";
import { openTechDetail } from "./explore-tech.js?v=4.99";
import { openDecade } from "./explore-decade.js?v=4.99";
import { openRotter, openOmHistorie, openHistorier, openAppGuide } from "./explore-innhold.js?v=4.99";
import { openInstrumenter } from "./explore-instrument.js?v=4.99";
