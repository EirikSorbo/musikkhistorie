...
import { modalOpen, escapeHtml, showSubsjangerInfo } from "./ui.js?v=5.00";
import { SKJUL_I_STUDENTVISNING } from "./feature-flags.js?v=5.00";
import { showEdgeInfo } from "./genealogy.js?v=5.00";
import { byggIndeks, sok, utdrag, marker } from "./search.js?v=5.00";
...
const PER_GRUPPE = 6;
import { opts, getState, onMainGenreClick, sjangerOpts } from "./explore-context.js?v=5.00";
import { openTechDetail } from "./explore-tech.js?v=5.00";
import { openDecade } from "./explore-decade.js?v=5.00";
import { openRotter, openOmHistorie, openHistorier, openAppGuide } from "./explore-innhold.js?v=5.00";
import { openInstrumenter } from "./explore-instrument.js?v=5.00";
