...
import { modalOpen, escapeHtml, showSubsjangerInfo } from "./ui.js?v=5.02";
import { SKJUL_I_STUDENTVISNING } from "./feature-flags.js?v=5.02";
import { showEdgeInfo } from "./genealogy.js?v=5.02";
import { byggIndeks, sok, utdrag, marker } from "./search.js?v=5.02";
...
const PER_GRUPPE = 6;
import { opts, getState, onMainGenreClick, sjangerOpts } from "./explore-context.js?v=5.02";
import { openTechDetail } from "./explore-tech.js?v=5.02";
import { openDecade } from "./explore-decade.js?v=5.02";
import { openRotter, openOmHistorie, openHistorier, openAppGuide } from "./explore-innhold.js?v=5.02";
import { openInstrumenter } from "./explore-instrument.js?v=5.02";
