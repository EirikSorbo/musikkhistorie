import { fetchPendingEdits, voteUp, undoVoteUp, getClientId, onAuthChange, fetchMineReturer, fetchReturMedKode } from "./store.js?v=5.59";
...
import { onGenreModelChanged } from "./genre-model.js?v=5.59";
import { instrumentsInUse, DECADES, isVisible, filterArtists, hasActiveFilters } from "./limits.js?v=5.59";
import { debounce, throttle, harSendtInn, normaliserReturKode } from "./util.js?v=5.59";
import { renderSpotlightCards, renderResultList, renderArtistDetail, renderArtists, fillSelect, modalOpen, modalCloseTop, setupModal, escapeHtml } from "./ui.js?v=5.59";
import { CONFIGURED, $, showSetupBanner, wireFirestoreErrorBanner } from "./shared.js?v=5.59";
import { GENEALOGY_MAIN_GENRES, GENEALOGY_META_GENRES } from "./genre-model.js?v=5.59";
import { initExplore } from "./explore.js?v=5.59";
import { lesVisFraUrl, provVisMaal } from "./explore-apne.js?v=5.59";
...
import { initUtskriftValg, leggTil as leggTilUtskrift } from "./utskrift-utvalg.js?v=5.59";
import { askChoice } from "./ui-modal.js?v=5.59";
import { openProposalEditor, openNewTechProposal, openReturInnsending } from "./proposals.js?v=5.59";
import { currentEntityValues } from "./entity-values.js?v=5.59";
import { loadArtists, saveArtists } from "./artist-cache.js?v=5.59";
