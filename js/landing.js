import { fetchPendingEdits, voteUp, undoVoteUp, getClientId, onAuthChange } from "./store.js?v=5.02";
import { subscribeSharedData, sharedStateDefaults } from "./shared-data.js?v=5.02";
import { SKJUL_I_STUDENTVISNING } from "./feature-flags.js?v=5.02";
import { onGenreModelChanged } from "./genre-model.js?v=5.02";
import { instrumentsInUse, DECADES, isVisible, filterArtists, hasActiveFilters } from "./limits.js?v=5.02";
import { debounce, throttle } from "./util.js?v=5.02";
import { renderSpotlightCards, renderResultList, renderArtistDetail, renderArtists, fillSelect, modalOpen, modalCloseTop, setupModal } from "./ui.js?v=5.02";
import { CONFIGURED, $, showSetupBanner, wireFirestoreErrorBanner } from "./shared.js?v=5.02";
import { GENEALOGY_MAIN_GENRES, GENEALOGY_META_GENRES } from "./genre-model.js?v=5.02";
import { initExplore } from "./explore.js?v=5.02";
import { openProposalEditor, openNewTechProposal } from "./proposals.js?v=5.02";
import { loadArtists, saveArtists } from "./artist-cache.js?v=5.02";
