import { fetchPendingEdits, voteUp, undoVoteUp, getClientId, onAuthChange } from "./store.js?v=4.73";
import { subscribeSharedData, sharedStateDefaults } from "./shared-data.js?v=4.73";
import { onGenreModelChanged } from "./genre-model.js?v=4.73";
import { INSTRUMENTS, DECADES, isVisible, filterArtists, hasActiveFilters } from "./limits.js?v=4.73";
import { debounce, throttle } from "./util.js?v=4.73";
import { renderSpotlightCards, renderResultList, renderArtistDetail, renderArtists, fillSelect, modalOpen, modalCloseTop, setupModal } from "./ui.js?v=4.73";
...
import { openProposalEditor, openNewTechProposal } from "./proposals.js?v=4.73";
import { loadArtists, saveArtists } from "./artist-cache.js?v=4.73";
