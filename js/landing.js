import { fetchPendingEdits, voteUp, undoVoteUp, getClientId, onAuthChange, fetchMineReturer, fetchReturMedKode } from "./store.js?v=5.69";
import { subscribeSharedData, sharedStateDefaults } from "./shared-data.js?v=5.69";
import { SKJUL_I_STUDENTVISNING } from "./feature-flags.js?v=5.69";
import { onGenreModelChanged } from "./genre-model.js?v=5.69";
import { instrumentsInUse, DECADES, isVisible, filterArtists, hasActiveFilters } from "./limits.js?v=5.69";
import { debounce, throttle, harSendtInn, normaliserReturKode } from "./util.js?v=5.69";
import { renderSpotlightCards, renderResultList, renderArtistDetail, renderArtists, fillSelect, modalOpen, modalCloseTop, setupModal, escapeHtml } from "./ui.js?v=5.69";
import { CONFIGURED, $, showSetupBanner, wireFirestoreErrorBanner } from "./shared.js?v=5.69";
import { GENEALOGY_MAIN_GENRES, GENEALOGY_META_GENRES } from "./genre-model.js?v=5.69";
import { initExplore } from "./explore.js?v=5.69";
import { lesVisFraUrl, provVisMaal } from "./explore-apne.js?v=5.69";
import { initPresentasjon, presPlanTikk } from "./presentasjon.js?v=5.69";
import { initPlanMeny } from "./plan-meny.js?v=5.69";
import { initPlanInnsamling, samleTikk } from "./plan-innsamling.js?v=5.69";
import { initVisning, visningTikk } from "./visning.js?v=5.69";
import { initUtskriftValg, leggTil as leggTilUtskrift, TIL_UTSKRIFT_SVG, UTSKRIFT_HAKE_SVG } from "./utskrift-utvalg.js?v=5.69";
import { askChoice } from "./ui-modal.js?v=5.69";
import { openProposalEditor, openNewTechProposal, openReturInnsending } from "./proposals.js?v=5.69";
import { currentEntityValues } from "./entity-values.js?v=5.69";
import { loadArtists, saveArtists } from "./artist-cache.js?v=5.69";
