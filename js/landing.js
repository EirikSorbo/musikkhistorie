...
import { DEFAULT_CONFIG, decadesForRange } from "./limits.js?v=2.30";
import { renderSpotlightCards, renderResultList, renderArtistDetail, renderArtists, fillSelect, escapeHtml, formatInfoText, buildPlaylistHtml, buildArtistListRows, modalOpen, modalClose, modalCloseTop, buildMainGenreList } from "./ui.js?v=2.30";
import { CONFIGURED, $, showSetupBanner } from "./shared.js";
import { GENEALOGY_MAIN_GENRES, renderGenealogy } from "./genealogy.js?v=2.30";
import { initExplore } from "./explore.js?v=2.30";
import { openProposalEditor, openNewTechProposal } from "./proposals.js?v=2.30";
