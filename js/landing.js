import { fetchPendingEdits, voteUp, undoVoteUp, getClientId, onAuthChange, fetchMineReturer, fetchReturMedKode } from "./store.js?v=5.51";
import { subscribeSharedData, sharedStateDefaults } from "./shared-data.js?v=5.51";
import { SKJUL_I_STUDENTVISNING } from "./feature-flags.js?v=5.51";
import { onGenreModelChanged } from "./genre-model.js?v=5.51";
import { instrumentsInUse, DECADES, isVisible, filterArtists, hasActiveFilters } from "./limits.js?v=5.51";
import { debounce, throttle, harSendtInn, normaliserReturKode } from "./util.js?v=5.51";
import { renderSpotlightCards, renderResultList, renderArtistDetail, renderArtists, fillSelect, modalOpen, modalCloseTop, setupModal, escapeHtml } from "./ui.js?v=5.51";
import { CONFIGURED, $, showSetupBanner, wireFirestoreErrorBanner } from "./shared.js?v=5.51";
import { GENEALOGY_MAIN_GENRES, GENEALOGY_META_GENRES } from "./genre-model.js?v=5.51";
import { initExplore } from "./explore.js?v=5.51";
import { lesVisFraUrl, provVisMaal } from "./explore-apne.js?v=5.51";
import { initPresentasjon, presPlanTikk } from "./presentasjon.js?v=5.51";
import { initPlanMeny } from "./plan-meny.js?v=5.51";
import { initPlanInnsamling, samleTikk } from "./plan-innsamling.js?v=5.51";
import { initVisning, visningTikk } from "./visning.js?v=5.51";
import { openProposalEditor, openNewTechProposal, openReturInnsending } from "./proposals.js?v=5.51";
import { currentEntityValues } from "./entity-values.js?v=5.51";
import { loadArtists, saveArtists } from "./artist-cache.js?v=5.51";
