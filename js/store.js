...
import { firebaseConfig } from "./firebase-config.js?v=3.99";
import { isMainGenre } from "./genealogy.js?v=3.99";
import { normalizeArtist, buildArtistDoc } from "./artist-normalize.js?v=3.99";
import { PROPOSABLE_KEYS } from "./proposal-fields.js?v=3.99";
import { mergeHeatRows } from "./import-format.js?v=3.99";
