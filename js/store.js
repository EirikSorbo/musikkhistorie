...
import { firebaseConfig } from "./firebase-config.js?v=3.92";
import { isMainGenre } from "./genealogy.js?v=3.92";
import { normalizeArtist, buildArtistDoc } from "./artist-normalize.js?v=3.92";
import { PROPOSABLE_KEYS } from "./proposal-fields.js?v=3.92";
import { mergeHeatRows } from "./import-format.js?v=3.92";
