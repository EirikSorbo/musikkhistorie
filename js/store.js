...
import { firebaseConfig } from "./firebase-config.js?v=3.7";
import { DEFAULT_CONFIG } from "./limits.js?v=3.7";
import { isMainGenre } from "./genealogy.js?v=3.7";
import { normalizeArtist, buildArtistDoc } from "./artist-normalize.js?v=3.7";
import { normalizeConfig } from "./config-normalize.js?v=3.7";
import { PROPOSABLE_KEYS } from "./proposal-fields.js?v=3.7";
