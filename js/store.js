...
import { firebaseConfig } from "./firebase-config.js?v=5.00";
import { isMainGenre } from "./genre-model.js?v=5.00";
import { normalizeArtist, buildArtistDoc } from "./artist-normalize.js?v=5.00";
import { PROPOSABLE_KEYS } from "./proposal-fields.js?v=5.00";
import { mergeHeatRows } from "./import-format.js?v=5.00";
import { BATCH_MAX } from "./genre-migrate.js?v=5.00";
import { DECADES, INSTRUMENT_TIMELINE_GROUPS, instrumentPageId } from "./limits.js?v=5.00";
