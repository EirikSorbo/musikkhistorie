...
import { firebaseConfig } from "./firebase-config.js?v=4.41";
import { isMainGenre } from "./genealogy.js?v=4.41";
import { normalizeArtist, buildArtistDoc } from "./artist-normalize.js?v=4.41";
import { PROPOSABLE_KEYS } from "./proposal-fields.js?v=4.41";
import { mergeHeatRows } from "./import-format.js?v=4.41";
