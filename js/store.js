...
import { firebaseConfig } from "./firebase-config.js?v=4.90";
import { isMainGenre } from "./genre-model.js?v=4.90";
import { normalizeArtist, buildArtistDoc } from "./artist-normalize.js?v=4.90";
import { PROPOSABLE_KEYS } from "./proposal-fields.js?v=4.90";
import { mergeHeatRows } from "./import-format.js?v=4.90";
import { BATCH_MAX } from "./genre-migrate.js?v=4.90";
import { DECADES, INSTRUMENT_TIMELINE_GROUPS, instrumentPageId } from "./limits.js?v=4.90";
