...
import { firebaseConfig } from "./firebase-config.js?v=2.94";
import { DEFAULT_CONFIG } from "./limits.js?v=2.94";
import { isMainGenre } from "./genealogy.js?v=2.94";
import { normalizeArtist, buildArtistDoc } from "./artist-normalize.js?v=2.94";
import { normalizeConfig } from "./config-normalize.js?v=2.94";
import { PROPOSABLE_KEYS } from "./proposal-fields.js?v=2.94";
