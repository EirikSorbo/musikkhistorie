...
import { firebaseConfig } from "./firebase-config.js?v=4.26";
import { isMainGenre } from "./genealogy.js?v=4.26";
import { normalizeArtist, buildArtistDoc } from "./artist-normalize.js?v=4.26";
import { PROPOSABLE_KEYS } from "./proposal-fields.js?v=4.26";
import { mergeHeatRows } from "./import-format.js?v=4.26";
