...
import { firebaseConfig } from "./firebase-config.js?v=5.67";
import { isMainGenre, GENEALOGY_MAIN_GENRES, GENEALOGY_META_GENRES, findTreeGenreNode } from "./genre-model.js?v=5.67";
import { normalizeArtist, buildArtistDoc, resubmitArtistFields } from "./artist-normalize.js?v=5.67";
import { RETUR_FELTER } from "./artist-schema.js?v=5.67";
import { genererReturKode, normaliserReturKode, merkHarSendtInn } from "./util.js?v=5.67";
import { PROPOSABLE_KEYS } from "./proposal-fields.js?v=5.67";
import { mergeHeatRows } from "./import-format.js?v=5.67";
import { BATCH_MAX } from "./genre-migrate.js?v=5.67";
import { DECADES, INSTRUMENT_TIMELINE_GROUPS, instrumentPageId } from "./limits.js?v=5.67";
...
function ryddReturfelter() {
  // Feltnavnene kommer fra RETUR_FELTER (artist-schema.js) — én kilde, så
  // opprydding, eksport og import aldri staver dem ulikt (audit-funn 40).
  // ownerUid ryddes bevisst ALDRI: den er studentens gjenfinning.
  return Object.fromEntries(RETUR_FELTER.map((f) => [f, deleteField()]));
}
