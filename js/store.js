...
import { firebaseConfig } from "./firebase-config.js?v=4.35";
import { isMainGenre } from "./genealogy.js?v=4.35";
import { normalizeArtist, buildArtistDoc } from "./artist-normalize.js?v=4.35";
import { PROPOSABLE_KEYS } from "./proposal-fields.js?v=4.35";
import { mergeHeatRows } from "./import-format.js?v=4.35";
