...
import { state, ctx, guardTeacherAction } from "./teacher-state.js?v=5.33";
import { escapeHtml, renderEditDiff, wireEditDiff, readApprovedFields, modalOpen, modalClose } from "./ui.js?v=5.33";
import { approveTech, deleteTech, approvePendingEdit, rejectPendingEdit, sendTilbake } from "./store.js?v=5.33";
import { currentEntityValues } from "./entity-values.js?v=5.33";
import { erTilModerasjon } from "./limits.js?v=5.33";
