...
import { state, guardTeacherAction } from "./teacher-state.js?v=3.38";
import { escapeHtml, renderEditDiff, wireEditDiff, readApprovedFields, modalOpen, modalClose } from "./ui.js?v=3.38";
import { resolveDesc } from "./genre-descriptions.js?v=3.38";
import { approveTech, deleteTech, approvePendingEdit, rejectPendingEdit, genreEditLevel } from "./store.js?v=3.38";
