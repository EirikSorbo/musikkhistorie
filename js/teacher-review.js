...
import { state } from "./teacher-state.js?v=2.80";
import { escapeHtml, renderEditDiff, wireEditDiff, readApprovedFields, modalOpen, modalClose } from "./ui.js?v=2.80";
import { resolveDesc } from "./genre-descriptions.js?v=2.80";
import { approveTech, deleteTech, approvePendingEdit, rejectPendingEdit, genreEditLevel } from "./store.js?v=2.80";
