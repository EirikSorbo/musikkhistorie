...
import { state, guardTeacherAction } from "./teacher-state.js?v=4.25";
import { escapeHtml, renderEditDiff, wireEditDiff, readApprovedFields, modalOpen, modalClose } from "./ui.js?v=4.25";
import { resolveDesc } from "./genre-descriptions.js?v=4.25";
import { resolveMainDesc } from "./genealogy.js?v=4.25";
import { approveTech, deleteTech, approvePendingEdit, rejectPendingEdit, genreEditLevel } from "./store.js?v=4.25";
