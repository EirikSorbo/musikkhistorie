...
import { escapeHtml, renderEditDiff, wireEditDiff, readApprovedFields, modalOpen, modalClose } from "./ui.js?v=4.63";
import { resolveDesc } from "./genre-descriptions.js?v=4.63";
import { resolveMainDesc } from "./genealogy.js?v=4.63";
import { approveTech, deleteTech, approvePendingEdit, rejectPendingEdit, genreEditLevel } from "./store.js?v=4.63";
