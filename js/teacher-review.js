...
import { state } from "./teacher-state.js?v=2.68";
import { escapeHtml, renderEditDiff, wireEditDiff, readApprovedFields, modalOpen, modalClose } from "./ui.js?v=2.68";
import { resolveDesc } from "./genre-descriptions.js?v=2.68";
import { approveTech, deleteTech, approvePendingEdit, rejectPendingEdit } from "./store.js?v=2.68";
