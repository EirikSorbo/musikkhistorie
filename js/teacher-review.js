...
import { state, ctx, guardTeacherAction } from "./teacher-state.js?v=5.40";
import { escapeHtml, renderEditDiff, wireEditDiff, readApprovedFields, modalOpen, modalClose } from "./ui.js?v=5.40";
import { approveTech, deleteTech, approvePendingEdit, rejectPendingEdit, sendTilbake } from "./store.js?v=5.40";
import { currentEntityValues } from "./entity-values.js?v=5.40";
import { erTilModerasjon } from "./limits.js?v=5.40";
