...
import { onAuthChange, savePlan, deletePlan } from "./store.js?v=5.53";
import { parseVisVerdi } from "./vis-lenke.js?v=5.53";
import { normaliserPlaner, nyPlanId, NIVAA_NAVN, lytteeksempelNavn } from "./presentasjon-modell.js?v=5.53";
import { GENEALOGY, GENEALOGY_META_GENRES, edgeExists } from "./genre-model.js?v=5.53";
import { INSTRUMENT_TIMELINE_GROUPS, isVisible } from "./limits.js?v=5.53";
import { askChoice, modalOpen, modalClose, setupModal, initModalHeaders } from "./ui-modal.js?v=5.53";
import { startInnsamling, avsluttInnsamling, aktivSamleokt, medOvertakelse, vedSamleEndring, forkastSamlinger } from "./plan-innsamling.js?v=5.53";
import { erLaererBruker, planeneLastet } from "./plan-meny.js?v=5.53";
import { erPresentasjon, aktivPlanId, avsluttPresentasjon } from "./presentasjon.js?v=5.53";
