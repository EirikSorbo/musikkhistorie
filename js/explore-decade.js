...
// ============================================================================
import { modalOpen, renderDecadeRibbon, renderDecadeSections, buildKilderList, formatInfoText } from "./ui.js?v=4.61";
import { DECADES } from "./limits.js?v=4.61";
import { openTechDetail, openTeknologi } from "./explore-tech.js?v=4.61";
import { opts, getState } from "./explore-context.js?v=4.61";
