...
// ============================================================================
import { modalOpen, renderDecadeRibbon, renderDecadeSections, buildKilderList } from "./ui.js?v=5.58";
import { DECADES } from "./limits.js?v=5.58";
import { openTechDetail, openTeknologi } from "./explore-tech.js?v=5.58";
import { opts, getState } from "./explore-context.js?v=5.58";
