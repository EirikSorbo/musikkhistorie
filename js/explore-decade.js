...
// ============================================================================
import { modalOpen, renderDecadeRibbon, renderDecadeSections, buildKilderList } from "./ui.js?v=4.99";
import { DECADES } from "./limits.js?v=4.99";
import { openTechDetail, openTeknologi } from "./explore-tech.js?v=4.99";
import { opts, getState } from "./explore-context.js?v=4.99";
