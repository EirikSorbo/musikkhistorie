...
// ============================================================================
import { modalOpen, renderDecadeRibbon, renderDecadeSections, buildKilderList } from "./ui.js?v=4.86";
import { DECADES } from "./limits.js?v=4.86";
import { openTechDetail, openTeknologi } from "./explore-tech.js?v=4.86";
import { opts, getState } from "./explore-context.js?v=4.86";
