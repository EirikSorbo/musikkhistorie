...
// ============================================================================
import { modalOpen, renderDecadeRibbon, renderDecadeSections, buildKilderList } from "./ui.js?v=5.00";
import { DECADES } from "./limits.js?v=5.00";
import { openTechDetail, openTeknologi } from "./explore-tech.js?v=5.00";
import { opts, getState } from "./explore-context.js?v=5.00";
