...
// ============================================================================
import { modalOpen, renderDecadeRibbon, renderDecadeSections, buildKilderList, formatInfoText } from "./ui.js?v=4.72";
import { DECADES } from "./limits.js?v=4.72";
import { openTechDetail, openTeknologi } from "./explore-tech.js?v=4.72";
import { opts, getState } from "./explore-context.js?v=4.72";
