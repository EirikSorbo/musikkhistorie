...
// ============================================================================
import { modalOpen, renderDecadeRibbon, renderDecadeSections, buildKilderList, formatInfoText } from "./ui.js?v=3.61";
import { DECADES } from "./limits.js?v=3.61";
import { openTechDetail, openTeknologi } from "./explore-tech.js?v=3.61";
