...
// ============================================================================
import { modalOpen, renderDecadeRibbon, renderDecadeSections, buildKilderList } from "./ui.js?v=5.13";
import { DECADES } from "./limits.js?v=5.13";
import { openTechDetail, openTeknologi } from "./explore-tech.js?v=5.13";
import { opts, getState } from "./explore-context.js?v=5.13";
