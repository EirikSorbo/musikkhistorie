...
// ============================================================================
import { modalOpen, renderDecadeRibbon, renderDecadeSections, buildKilderList, formatInfoText } from "./ui.js?v=4.47";
import { DECADES } from "./limits.js?v=4.47";
import { openTechDetail, openTeknologi } from "./explore-tech.js?v=4.47";
import { opts, getState } from "./explore-context.js?v=4.47";
