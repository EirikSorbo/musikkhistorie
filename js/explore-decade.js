...
// ============================================================================
import { modalOpen, renderDecadeRibbon, renderDecadeSections, buildKilderList, formatInfoText } from "./ui.js?v=3.78";
import { DECADES } from "./limits.js?v=3.78";
import { openTechDetail, openTeknologi } from "./explore-tech.js?v=3.78";
