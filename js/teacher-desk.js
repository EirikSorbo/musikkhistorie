...
import { state, ctx, renderList, setContentCheck } from "./teacher-state.js?v=4.67";
import { modalOpen } from "./ui.js?v=4.67";
import { renderPendingEditsList } from "./teacher-review.js?v=4.67";
import { openDetail } from "./teacher-artists.js?v=4.67";
import { openSingleEdgeModal, openSingleDecadeModal } from "./teacher-content.js?v=4.67";
import { GENEALOGY_EDGES, GENEALOGY_MAIN_GENRES, GENEALOGY_META_GENRES, edgeKey, isMainGenre, genreNodeById } from "./genre-model.js?v=4.67";
import { DECADES, isVisible } from "./limits.js?v=4.67";
import { escapeHtml, pct } from "./ui-helpers.js?v=4.67";
