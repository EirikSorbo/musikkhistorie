...
import { state, ctx, renderList, setContentCheck } from "./teacher-state.js?v=5.25";
import { modalOpen } from "./ui.js?v=5.25";
import { renderPendingEditsList } from "./teacher-review.js?v=5.25";
import { openDetail } from "./teacher-artists.js?v=5.25";
import { openSingleEdgeModal, openSingleDecadeModal } from "./teacher-content.js?v=5.25";
import { GENEALOGY_EDGES, GENEALOGY_MAIN_GENRES, edgeKey, isMainGenre, genreNodeById } from "./genre-model.js?v=5.25";
import { storyOrder } from "./story-format.js?v=5.25";
import { DECADES, isVisible, erTilModerasjon } from "./limits.js?v=5.25";
import { escapeHtml, pct } from "./ui-helpers.js?v=5.25";
