...
import { state, ctx, renderList, setContentCheck } from "./teacher-state.js?v=3.16";
import { modalOpen } from "./ui.js?v=3.16";
import { renderPendingEditsList } from "./teacher-review.js?v=3.16";
import { openDetail } from "./teacher-artists.js?v=3.16";
import { GENEALOGY_MAIN_GENRES, isMainGenre } from "./genealogy.js?v=3.16";
import { escapeHtml, pct } from "./ui-helpers.js?v=3.16";
