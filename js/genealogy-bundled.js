...
import { showSjangerInfo, showEdgeInfo } from "./genealogy.js?v=4.60";
import { GENEALOGY, nodeColor, layoutX } from "./genre-model.js?v=4.60";
import { attachCamera } from "./gx-camera.js?v=4.60";
import { LAYOUT_WIDTH } from "./genre-layout.js?v=4.60";
