...
import { showSjangerInfo, showEdgeInfo } from "./genealogy.js?v=5.58";
import { SKJUL_I_STUDENTVISNING } from "./feature-flags.js?v=5.58";
import { GENEALOGY, DECADE_ROWS, nodeColor, layoutX } from "./genre-model.js?v=5.58";
import { attachCamera } from "./gx-camera.js?v=5.58";
import { LAYOUT_WIDTH } from "./genre-layout.js?v=5.58";
