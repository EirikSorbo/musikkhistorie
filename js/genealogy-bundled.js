...
import { showSjangerInfo, showEdgeInfo } from "./genealogy.js?v=4.61";
import { GENEALOGY, nodeColor, layoutX } from "./genre-model.js?v=4.61";
import { attachCamera } from "./gx-camera.js?v=4.61";
import { LAYOUT_WIDTH } from "./genre-layout.js?v=4.61";
