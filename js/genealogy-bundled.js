...
import { showSjangerInfo, showEdgeInfo } from "./genealogy.js?v=4.88";
import { SKJUL_I_STUDENTVISNING } from "./feature-flags.js?v=4.88";
import { GENEALOGY, DECADE_ROWS, nodeColor, layoutX } from "./genre-model.js?v=4.88";
import { attachCamera } from "./gx-camera.js?v=4.88";
import { LAYOUT_WIDTH } from "./genre-layout.js?v=4.88";
