...
import { state, ctx, openAdminModal, closeAdminModal } from "./teacher-state.js?v=3.0";
import { saveDecadeDesc, saveGenreDescLevel, saveStoryBody, clearStory, addTech, updateTech, deleteTech, addPodcast, deletePodcast } from "./store.js?v=3.0";
import { renderStoryHtml, storyFor } from "./story-format.js?v=3.0";
import { escapeHtml, formatInfoText, buildKilderList, buildMainGenreList, renderDecadeSections, setupModal, modalOpen, techImage } from "./ui.js?v=3.0";
import { resolveDesc } from "./genre-descriptions.js?v=3.0";
import { podcastEpisodeHtml } from "./ui-helpers.js?v=3.0";

const LEVEL_LABEL = { meta: "hovedsjanger", main: "sjanger", sub: "undersjanger" };
import { linkifyAll, wireAllLinks } from "./linkify.js?v=3.0";
import { $ } from "./shared.js?v=3.0";
import { SOURCE_SPEC, addRow, collectRows } from "./row-editor.js?v=3.0";
