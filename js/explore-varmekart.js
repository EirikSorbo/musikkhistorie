...
// ============================================================================
import { escapeHtml, modalOpen } from "./ui.js?v=5.42";
import { GENEALOGY_MAIN_GENRES, META_GENRE_ORDER, MAIN_GENRE_INFO, FAMILIES } from "./genre-model.js?v=5.42";
import { opts, getState, groupColor, metaGroupHeadHtml, wireMetaAccordion } from "./explore-context.js?v=5.42";
import { heatColor, heatRow, HEAT_NODATA } from "./heat-strip.js?v=5.42";
