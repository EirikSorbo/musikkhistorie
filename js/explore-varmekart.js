...
// ============================================================================
import { escapeHtml, modalOpen, modalClose } from "./ui.js?v=5.02";
import { DECADES } from "./limits.js?v=5.02";
import { GENEALOGY_MAIN_GENRES, META_GENRE_ORDER, MAIN_GENRE_INFO, FAMILIES } from "./genre-model.js?v=5.02";
import { opts, getState, groupColor, metaGroupHeadHtml, wireMetaAccordion, onMainGenreClick } from "./explore-context.js?v=5.02";
import { heatColor, heatRow, heatStripHtml, heatAxisHtml, HEAT_NODATA } from "./heat-strip.js?v=5.02";
