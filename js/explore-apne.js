...
import { opts, getState, onMainGenreClick, sjangerOpts } from "./explore-context.js?v=5.47";
import { showSubsjangerInfo } from "./ui.js?v=5.47";
import { showEdgeInfo } from "./genealogy.js?v=5.47";
import { openTechDetail, openTeknologi } from "./explore-tech.js?v=5.47";
import { openDecade } from "./explore-decade.js?v=5.47";
import { openRotter, openOmHistorie, openHistorier, openAppGuide, openStoreBildet, openSjangerhimmel } from "./explore-innhold.js?v=5.47";
import { openInstrumenter, openPodkaster } from "./explore-instrument.js?v=5.47";
...
import { ytWatchUrl, lytteeksempelNavn } from "./presentasjon-modell.js?v=5.47";
import { apneYtSpiller } from "./yt-spiller.js?v=5.47";
