...
import { isVisible, filterArtists, hasActiveFilters } from "./limits.js?v=4.74";
import { showSjangerInfo } from "./genealogy.js?v=4.74";
import { GENEALOGY_MAIN_GENRES, findTreeGenreNode } from "./genre-model.js?v=4.74";
import { resolveDesc, missingDesc } from "./genre-descriptions.js?v=4.74";
import {
  escapeHtml,
  linkDesc,
  wireLinks,
  ...
  ICONS,
  renderGenreEditBtn,
} from "./ui-helpers.js?v=4.74";
import { modalOpen, modalClose, modalCloseTop, setupModal, initModalHeaders } from "./ui-modal.js?v=4.74";
import { TECH_CATEGORIES, TECH_CATEGORY_TABS, TECH_TYPES, renderTechList, renderTechDetail, techImage } from "./ui-tech.js?v=4.74";
import { buildTimeline, buildTechTimeline, renderDecadeSections, renderDecadeRibbon } from "./ui-timeline.js?v=4.74";
import { renderDashboard, contentGaps } from "./ui-dashboard.js?v=4.74";
import { wireProposeFoot, diffFields, renderEditDiff, readApprovedFields, wireEditDiff } from "./ui-edit.js?v=4.74";
