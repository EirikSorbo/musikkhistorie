...
import { isVisible, filterArtists } from "./limits.js?v=2.81";
import { GENEALOGY_MAIN_GENRES, isMainGenre, showSjangerInfo } from "./genealogy.js?v=2.81";
...
import {
  ...
  PRIO_ICONS,
  PRIO_LABELS,
} from "./ui-helpers.js?v=2.81";
import { modalOpen, modalClose, modalCloseTop, modalCloseAll, setupModal, initModalHeaders } from "./ui-modal.js?v=2.81";
import { TECH_CATEGORIES, renderTechList, renderTechDetail, techImage } from "./ui-tech.js?v=2.81";
import { buildTimeline, buildTechTimeline, renderDecadeSections } from "./ui-timeline.js?v=2.81";
import { renderDashboard, renderLimits } from "./ui-dashboard.js?v=2.81";
import { fieldLabelFor, wireProposeFoot, diffFields, renderEditDiff, readApprovedFields, wireEditDiff } from "./ui-edit.js?v=2.81";
