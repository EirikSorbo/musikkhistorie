...
import { isVisible, filterArtists } from "./limits.js?v=3.23";
import { GENEALOGY_MAIN_GENRES, isMainGenre, showSjangerInfo } from "./genealogy.js?v=3.23";
...
import {
  ...
  PRIO_ICONS,
  PRIO_LABELS,
} from "./ui-helpers.js?v=3.23";
import { modalOpen, modalClose, modalCloseTop, setupModal, initModalHeaders } from "./ui-modal.js?v=3.23";
import { TECH_CATEGORIES, renderTechList, renderTechDetail, techImage } from "./ui-tech.js?v=3.23";
import { buildTimeline, buildTechTimeline, renderDecadeSections } from "./ui-timeline.js?v=3.23";
import { renderDashboard, contentGaps } from "./ui-dashboard.js?v=3.23";
import { wireProposeFoot, diffFields, renderEditDiff, readApprovedFields, wireEditDiff } from "./ui-edit.js?v=3.23";
