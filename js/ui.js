...
import { isVisible, filterArtists } from "./limits.js?v=3.4";
import { GENEALOGY_MAIN_GENRES, isMainGenre, showSjangerInfo } from "./genealogy.js?v=3.4";
...
import {
  ...
  PRIO_ICONS,
  PRIO_LABELS,
} from "./ui-helpers.js?v=3.4";
import { modalOpen, modalClose, modalCloseTop, setupModal, initModalHeaders } from "./ui-modal.js?v=3.4";
import { TECH_CATEGORIES, renderTechList, renderTechDetail, techImage } from "./ui-tech.js?v=3.4";
import { buildTimeline, buildTechTimeline, renderDecadeSections } from "./ui-timeline.js?v=3.4";
import { renderDashboard, renderLimits } from "./ui-dashboard.js?v=3.4";
import { wireProposeFoot, diffFields, renderEditDiff, readApprovedFields, wireEditDiff } from "./ui-edit.js?v=3.4";
