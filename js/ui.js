...
import { isVisible, erTilModerasjon, filterArtists, hasActiveFilters, INSTRUMENT_GROUPS } from "./limits.js?v=5.27";
import { SKJUL_I_STUDENTVISNING } from "./feature-flags.js?v=5.27";
import { showSjangerInfo, clearOpenSjanger } from "./genealogy.js?v=5.27";
import { GENEALOGY_MAIN_GENRES, findTreeGenreNode } from "./genre-model.js?v=5.27";
...
import {
  ...
  ICONS,
  renderGenreEditBtn,
} from "./ui-helpers.js?v=5.27";
import { modalOpen, modalClose, modalCloseTop, setupModal, initModalHeaders } from "./ui-modal.js?v=5.27";
import { TECH_CATEGORIES, TECH_CATEGORY_TABS, TECH_TYPES, renderTechList, renderTechCards, renderTechDetail, techImage } from "./ui-tech.js?v=5.27";
import { buildTechTimeline, renderDecadeSections, renderDecadeRibbon } from "./ui-timeline.js?v=5.27";
import { renderDashboard, contentGaps } from "./ui-dashboard.js?v=5.27";
import { wireProposeFoot, diffFields, renderEditDiff, readApprovedFields, wireEditDiff } from "./ui-edit.js?v=5.27";
