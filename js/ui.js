...
import { isVisible, filterArtists, hasActiveFilters, INSTRUMENT_GROUPS } from "./limits.js?v=5.08";
import { SKJUL_I_STUDENTVISNING } from "./feature-flags.js?v=5.08";
import { showSjangerInfo } from "./genealogy.js?v=5.08";
import { GENEALOGY_MAIN_GENRES, findTreeGenreNode } from "./genre-model.js?v=5.08";
import { resolveDesc, missingDesc } from "./genre-descriptions.js?v=5.08";
import {
  escapeHtml,
  linkDesc,
  wireLinks,
  ...
  ICONS,
  renderGenreEditBtn,
} from "./ui-helpers.js?v=5.08";
import { modalOpen, modalClose, modalCloseTop, setupModal, initModalHeaders } from "./ui-modal.js?v=5.08";
import { TECH_CATEGORIES, TECH_CATEGORY_TABS, TECH_TYPES, renderTechList, renderTechCards, renderTechDetail, techImage } from "./ui-tech.js?v=5.08";
import { buildTechTimeline, renderDecadeSections, renderDecadeRibbon } from "./ui-timeline.js?v=5.08";
import { renderDashboard, contentGaps } from "./ui-dashboard.js?v=5.08";
import { wireProposeFoot, diffFields, renderEditDiff, readApprovedFields, wireEditDiff } from "./ui-edit.js?v=5.08";
