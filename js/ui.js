...
import {
  ...
  decadesForRange,
  GENDERS,
} from "./limits.js?v=2.38";
import { GENEALOGY_MAIN_GENRES } from "./genealogy.js?v=2.38";
import { escapeHtml } from "./util.js?v=2.38";
import { linkifyAll, linkifyArtists, wireAllLinks, wireArtistLinks, wireTechLinks } from "./linkify.js?v=2.38";
import { modalOpen, modalClose, modalCloseTop, modalCloseAll, setupModal } from "./ui-modal.js?v=2.38";
