...
import { isVisible, filterArtists, hasActiveFilters } from "./limits.js?v=3.54";
import { GENEALOGY_MAIN_GENRES, isMainGenre, findTreeGenreNode, showSjangerInfo } from "./genealogy.js?v=3.54";
...
import {
  ...
  PRIO_LABELS,
  ICONS,
} from "./ui-helpers.js?v=3.54";
import { modalOpen, modalClose, modalCloseTop, setupModal, initModalHeaders } from "./ui-modal.js?v=3.54";
import { TECH_CATEGORIES, TECH_CATEGORY_TABS, renderTechList, renderTechDetail, techImage } from "./ui-tech.js?v=3.54";
import { buildTimeline, buildTechTimeline, renderDecadeSections, renderDecadeRibbon } from "./ui-timeline.js?v=3.54";
import { renderDashboard, contentGaps } from "./ui-dashboard.js?v=3.54";
import { wireProposeFoot, diffFields, renderEditDiff, readApprovedFields, wireEditDiff } from "./ui-edit.js?v=3.54";
