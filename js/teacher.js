...
import {
  ...
  signInWithGoogle,
  signOutTeacher,
} from "./store.js?v=4.91";
import { subscribeSharedData } from "./shared-data.js?v=4.91";
import { onGenreModelChanged } from "./genre-model.js?v=4.91";
import { TEACHER_EMAILS } from "./firebase-config.js?v=4.91";
import { CONFIGURED, $, showSetupBanner, wireFirestoreErrorBanner } from "./shared.js?v=4.91";
import { initExplore } from "./explore.js?v=4.91";

import { state, ctx, renderAll, refreshControls, openAdminModal, setContentCheck, guardTeacherAction, setupModals } from "./teacher-state.js?v=4.91";
import { openDetail, addMainGenreCheckToggle, openOversikt, setupFilters, setupEditForm } from "./teacher-artists.js?v=4.91";
import {
  openDecadeAdmin,
  ...
  openTechEditor,
  refreshTechAdmin,
} from "./teacher-content.js?v=4.91";
import { renderPendingEditsList, setupPendingEditsUi } from "./teacher-review.js?v=4.91";
import { renderDesk } from "./teacher-desk.js?v=4.91";
import { setupDataButtons, setupImportChoice } from "./teacher-import.js?v=4.91";
import { setupFormatBars } from "./format-bar.js?v=4.91";
import { GENRE_ADMIN_HTML, openGenreAdmin, setupGenreAdmin, refreshGenreAdmin } from "./teacher-genres.js?v=4.91";
