...
import {
  ...
  signInWithGoogle,
  signOutTeacher,
} from "./store.js?v=5.70";
import { subscribeSharedData } from "./shared-data.js?v=5.70";
...
import { state, ctx, renderAll, refreshControls, openAdminModal, setContentCheck, guardTeacherAction, setupModals } from "./teacher-state.js?v=5.70";
import { openDetail, addMainGenreCheckToggle, openOversikt, setupFilters, setupEditForm } from "./teacher-artists.js?v=5.70";
import {
  openDecadeAdmin,
  ...
  openTechEditor,
  refreshTechAdmin,
} from "./teacher-content.js?v=5.70";
import { renderPendingEditsList, setupPendingEditsUi } from "./teacher-review.js?v=5.70";
...
import { initUtskriftValg } from "./utskrift-utvalg.js?v=5.70";
import { renderDesk } from "./teacher-desk.js?v=5.70";
import { setupDataButtons, setupImportChoice } from "./teacher-import.js?v=5.70";
import { setupFormatBars } from "./format-bar.js?v=5.70";
import { GENRE_ADMIN_HTML, openGenreAdmin, setupGenreAdmin, refreshGenreAdmin } from "./teacher-genres.js?v=5.70";
