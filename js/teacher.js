...
import {
  ...
  signInWithGoogle,
  signOutTeacher,
} from "./store.js?v=5.37";
import { subscribeSharedData } from "./shared-data.js?v=5.37";
...
import { state, ctx, renderAll, refreshControls, openAdminModal, setContentCheck, guardTeacherAction, setupModals } from "./teacher-state.js?v=5.37";
import { openDetail, addMainGenreCheckToggle, openOversikt, setupFilters, setupEditForm } from "./teacher-artists.js?v=5.37";
import {
  openDecadeAdmin,
  ...
  openTechEditor,
  refreshTechAdmin,
} from "./teacher-content.js?v=5.37";
import { renderPendingEditsList, setupPendingEditsUi } from "./teacher-review.js?v=5.37";
import { openPresentasjonAdmin, renderPresentasjonAdmin, setupPresentasjonAdmin } from "./teacher-presentasjoner.js?v=5.37";
import { initPlanMeny } from "./plan-meny.js?v=5.37";
import { initPlanInnsamling, samleTikk } from "./plan-innsamling.js?v=5.37";
import { renderDesk } from "./teacher-desk.js?v=5.37";
import { setupDataButtons, setupImportChoice } from "./teacher-import.js?v=5.37";
import { setupFormatBars } from "./format-bar.js?v=5.37";
import { GENRE_ADMIN_HTML, openGenreAdmin, setupGenreAdmin, refreshGenreAdmin } from "./teacher-genres.js?v=5.37";
