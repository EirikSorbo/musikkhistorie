...
import { savePlan, onAuthChange } from "./store.js?v=5.57";
import { getState } from "./explore-context.js?v=5.57";
import { normaliserPlaner, normaliserSamleOps, brukSamleOps, samleMerke, samleVentende, samleTast } from "./presentasjon-modell.js?v=5.57";
import { setModalApnetProvider, topOpenModal } from "./ui-modal.js?v=5.57";
import { escapeHtml } from "./util.js?v=5.57";
import { parseVisVerdi, erSkrivefelt } from "./vis-lenke.js?v=5.57";
import { registrerYtIntercept } from "./yt-spiller.js?v=5.57";
import { aktivPlanId } from "./presentasjon.js?v=5.57";
import { erLaererBruker } from "./plan-meny.js?v=5.57";
