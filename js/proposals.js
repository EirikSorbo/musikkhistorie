...
import { addPendingEdit, addTechProposal } from "./store.js?v=3.15";
import { diffFields, escapeHtml, modalOpen, modalClose } from "./ui.js?v=3.15";
import { ARTIST_FIELDS } from "./artist-schema.js?v=3.15";
