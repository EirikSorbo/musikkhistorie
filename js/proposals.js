...
import { addPendingEdit, addTechProposal } from "./store.js?v=2.77";
import { diffFields, escapeHtml, modalOpen, modalClose } from "./ui.js?v=2.77";
import { ARTIST_FIELDS } from "./artist-schema.js?v=2.77";
