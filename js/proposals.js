...
import { addPendingEdit, addTechProposal } from "./store.js?v=4.34";
import { diffFields, escapeHtml, modalOpen, modalClose, TECH_CATEGORIES, TECH_TYPES } from "./ui.js?v=4.34";
import { ARTIST_FIELDS } from "./artist-schema.js?v=4.34";
import { GENDERS, INSTRUMENT_TIMELINE_GROUPS } from "./limits.js?v=4.34";
