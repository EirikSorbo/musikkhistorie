...
import { addPendingEdit, addTechProposal } from "./store.js?v=3.55";
import { diffFields, escapeHtml, modalOpen, modalClose, TECH_CATEGORIES } from "./ui.js?v=3.55";
import { ARTIST_FIELDS } from "./artist-schema.js?v=3.55";
