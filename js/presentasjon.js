...
import { FLATER, NIVAA_NAVN, erSynlig, faktaSynlig, normaliserPlaner, klampStopp } from "./presentasjon-modell.js?v=5.33";
import { erSkrivefelt, parseVisVerdi } from "./vis-lenke.js?v=5.33";
import { modalClose } from "./ui-modal.js?v=5.33";
import { registrerYtIntercept } from "./yt-spiller.js?v=5.33";
import { escapeHtml } from "./util.js?v=5.33";
import { apneVisNaarKlart } from "./explore-apne.js?v=5.33";
import { getState } from "./explore-context.js?v=5.33";
