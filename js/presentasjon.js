...
import { FLATER, NIVAA_NAVN, erSynlig, faktaSynlig, normaliserPlaner, planPosisjon, tellerTekst, planOversikt, innsettingsIndeks, medStoppSattInn, presTast, PRES_TASTER } from "./presentasjon-modell.js?v=5.65";
import { erSkrivefelt, parseVisVerdi } from "./vis-lenke.js?v=5.65";
import { modalOpen, modalClose, setupModal, initModalHeaders, topOpenModal } from "./ui-modal.js?v=5.65";
import { GENEALOGY } from "./genre-model.js?v=5.65";
import { ordneArtistLerret, flyttLevetid, ryddArtistLerret } from "./pres-artist.js?v=5.65";
import { registrerYtIntercept, veksleYtAvspilling } from "./yt-spiller.js?v=5.65";
import { escapeHtml } from "./util.js?v=5.65";
import { apneVisNaarKlart } from "./explore-apne.js?v=5.65";
import { getState } from "./explore-context.js?v=5.65";
import { onAuthChange } from "./store.js?v=5.65";
import { erLaererBruker, settInnStopp } from "./plan-meny.js?v=5.65";
