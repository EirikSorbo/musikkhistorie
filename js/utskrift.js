...
import { sharedStateDefaults, subscribeSharedData } from "./shared-data.js?v=5.69";
import { CONFIGURED, showSetupBanner, wireFirestoreErrorBanner } from "./shared.js?v=5.69";
import { onAuthChange } from "./store.js?v=5.69";
import { TEACHER_EMAILS } from "./firebase-config.js?v=5.69";
import { SKJUL_I_STUDENTVISNING, SKJUL_I_HUBEN, PUNKTER_BARE_I_PRESENTASJON } from "./feature-flags.js?v=5.69";
import { settSammen, foreslaaTittel, tellingerTekst, heltPensum, DELER, TYPE_ETIKETT, META_PREFIKS, normaliserTittel, kanoniskVis, TITTEL_MAKS } from "./utskrift-modell.js?v=5.69";
import { lesUtvalg, lagreUtvalg, leggTil, huk, toem, initUtskriftValg, UTSKRIFT_HENDELSE } from "./utskrift-utvalg.js?v=5.69";
import { byggIndeks, sok, normaliser, TYPE_LABEL } from "./search.js?v=5.69";
import { byggVisVerdi } from "./vis-lenke.js?v=5.69";
import { renderRichText, renderInline } from "./rich-text.js?v=5.69";
import { formatInfoText, musicExampleLabel } from "./ui-helpers.js?v=5.69";
import { escapeHtml, wikimediaThumb } from "./util.js?v=5.69";
import { heatColor, HEAT_NODATA } from "./heat-strip.js?v=5.69";
import { artistStripHtml } from "./artist-strip.js?v=5.69";
import { DECADES, isVisible } from "./limits.js?v=5.69";
import { askChoice } from "./ui-modal.js?v=5.69";
import { onGenreModelChanged, GENEALOGY, META_GENRE_ORDER } from "./genre-model.js?v=5.69";
