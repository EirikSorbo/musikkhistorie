...
import { onAuthChange, savePresentasjoner } from "./store.js?v=5.27";
import { TEACHER_EMAILS } from "./firebase-config.js?v=5.27";
import { getState } from "./explore-context.js?v=5.27";
import { normaliserPlaner, nyPlanId } from "./presentasjon-modell.js?v=5.27";
import { setLenkeMenyProvider } from "./ui-modal.js?v=5.27";
