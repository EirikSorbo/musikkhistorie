...
import { state, ctx, openAdminModal, closeAdminModal, renderList, updatePendingBadge, guardTeacherAction } from "./teacher-state.js?v=2.98";
import { updateArtistFields, setTeacherChecks } from "./store.js?v=2.98";
import { renderArtistDetail, renderDashboard, fillSelect, modalOpen, modalClose } from "./ui.js?v=2.98";
import { isMainGenre } from "./genealogy.js?v=2.98";
import { openSingleSubgenreModal } from "./teacher-content.js?v=2.98";
import { GENDERS } from "./limits.js?v=2.98";
import { debounce } from "./util.js?v=2.98";
