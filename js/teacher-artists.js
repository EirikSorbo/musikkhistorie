...
import { state, ctx, openAdminModal, closeAdminModal, renderList, updatePendingBadge } from "./teacher-state.js?v=2.68";
import { updateArtistFields, setTeacherChecks } from "./store.js?v=2.68";
import { escapeHtml, renderArtistDetail, renderDashboard, fillSelect, modalOpen, modalClose } from "./ui.js?v=2.68";
import { isMainGenre } from "./genealogy.js?v=2.68";
import { openSingleSubgenreModal } from "./teacher-content.js?v=2.68";
