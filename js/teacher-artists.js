...
import { state, ctx, openAdminModal, closeAdminModal, renderList, guardTeacherAction, setContentCheck } from "./teacher-state.js?v=3.24";
import { updateArtistFields, setTeacherChecks } from "./store.js?v=3.24";
import { renderArtistDetail, renderDashboard, fillSelect, modalOpen, modalClose, artistsInGenre, openArtistListModal } from "./ui.js?v=3.24";
import { isMainGenre, edgeKey, GENEALOGY_META_GENRES } from "./genealogy.js?v=3.24";
import { openSingleSubgenreModal, openSingleEdgeModal } from "./teacher-content.js?v=3.24";
import { checkBtnHtml, setCheckBtn, toggleCheckBtn } from "./ui-helpers.js?v=3.24";
import { GENDERS } from "./limits.js?v=3.24";
import { debounce } from "./util.js?v=3.24";
import { $ } from "./shared.js?v=3.24";
import { WORK_SPEC, MUSIC_SPEC, SOURCE_SPEC, addRow, buildRows, collectRows } from "./row-editor.js?v=3.24";
