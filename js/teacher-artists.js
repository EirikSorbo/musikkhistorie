...
import { state, ctx, openAdminModal, closeAdminModal, renderList, guardTeacherAction } from "./teacher-state.js?v=3.15";
import { updateArtistFields, setTeacherChecks } from "./store.js?v=3.15";
import { renderArtistDetail, renderDashboard, fillSelect, modalOpen, modalClose, artistsInGenre, openArtistListModal } from "./ui.js?v=3.15";
import { isMainGenre } from "./genealogy.js?v=3.15";
import { openSingleSubgenreModal } from "./teacher-content.js?v=3.15";
import { GENDERS } from "./limits.js?v=3.15";
import { debounce } from "./util.js?v=3.15";
import { $ } from "./shared.js?v=3.15";
import { WORK_SPEC, MUSIC_SPEC, SOURCE_SPEC, addRow, buildRows, collectRows } from "./row-editor.js?v=3.15";
