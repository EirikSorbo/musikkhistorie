...
import { safeUrl } from "./util.js?v=5.52";
import { ARTIST_FIELDS, RETUR_FELTER, emptyValueFor } from "./artist-schema.js?v=5.52";
import { normaliserPunkter } from "./punkter.js?v=5.52";
