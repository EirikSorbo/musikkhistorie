...
import { state, openAdminModal, closeAdminModal } from "./teacher-state.js?v=5.19";
import {
  addArtistsBulk,
  deleteAllArtists,
  updateTech,
...
import { escapeHtml } from "./ui.js?v=5.19";
import { $ } from "./shared.js?v=5.19";
import { GENEALOGY_META_GENRES, isMainGenre } from "./genre-model.js?v=5.19";
import { validateTree } from "./genre-validate.js?v=5.19";
import { ARTIST_LABELS, ARTIST_COMPARE_FIELDS, ARTIST_EXPORT_FIELDS } from "./artist-schema.js?v=5.19";
import { INSTRUMENTS } from "./limits.js?v=5.19";
import { validateArtistsForImport, normalizeImportFile, CONTENT_KEYS, decadeDoc } from "./import-format.js?v=5.19";
