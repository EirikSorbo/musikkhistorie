...
import { state, openAdminModal, closeAdminModal } from "./teacher-state.js?v=3.99";
import {
  addArtistsBulk,
  deleteAllArtists,
  updateTech,
...
import { escapeHtml } from "./ui.js?v=3.99";
import { $ } from "./shared.js?v=3.99";
import { GENEALOGY_META_GENRES, isMainGenre } from "./genealogy.js?v=3.99";
import { ARTIST_LABELS, ARTIST_COMPARE_FIELDS, ARTIST_EXPORT_FIELDS } from "./artist-schema.js?v=3.99";
import { INSTRUMENTS } from "./limits.js?v=3.99";
import { flattenGenreDescriptions, validateArtistsForImport } from "./import-format.js?v=3.99";
