...
import { state, openAdminModal, closeAdminModal } from "./teacher-state.js?v=5.40";
import {
  addArtistsBulk,
  deleteAllArtists,
  updateTech,
...
import { GENEALOGY_META_GENRES, isMainGenre } from "./genre-model.js?v=5.40";
import { validateTree } from "./genre-validate.js?v=5.40";
import { ARTIST_LABELS, ARTIST_COMPARE_FIELDS, ARTIST_EXPORT_FIELDS } from "./artist-schema.js?v=5.40";
import { INSTRUMENTS } from "./limits.js?v=5.40";
import { validateArtistsForImport, normalizeImportFile, CONTENT_KEYS, decadeDoc } from "./import-format.js?v=5.40";
