...
import { state, openAdminModal, closeAdminModal } from "./teacher-state.js?v=2.84";
import {
  addArtistsBulk,
  deleteAllArtists,
  updateTech,
...
import { escapeHtml } from "./ui.js?v=2.84";
import { $ } from "./shared.js?v=2.84";
import { GENEALOGY_META_GENRES, isMainGenre } from "./genealogy.js?v=2.84";
import { ARTIST_LABELS, ARTIST_COMPARE_FIELDS, ARTIST_EXPORT_FIELDS } from "./artist-schema.js?v=2.84";
import { flattenGenreDescriptions, validateArtistsForImport } from "./import-format.js?v=2.84";
