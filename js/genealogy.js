...
import { escapeHtml, buildKilderList } from "./util.js?v=3.38";
import { resolveDescAny, missingDesc } from "./genre-descriptions.js?v=3.38";
import { modalOpen, modalClose } from "./ui-modal.js?v=3.38";
