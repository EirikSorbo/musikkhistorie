...
import { escapeHtml, buildKilderList } from "./util.js?v=5.46";
import { resolveDesc, resolveDescAny, missingDesc } from "./genre-descriptions.js?v=5.46";
import { modalOpen } from "./ui-modal.js?v=5.46";
import { renderGenreEditBtn, sekt } from "./ui-helpers.js?v=5.46";
import { wireProposeFoot } from "./ui-edit.js?v=5.46";
import { heatRow, heatStripHtml, heatAxisHtml, getHeatData } from "./heat-strip.js?v=5.46";
import { GENEALOGY, edgeKey, nodeColor, edgeExists } from "./genre-model.js?v=5.46";
