...
import { escapeHtml, buildKilderList } from "./util.js?v=5.16";
import { resolveDesc, resolveDescAny, missingDesc } from "./genre-descriptions.js?v=5.16";
import { modalOpen } from "./ui-modal.js?v=5.16";
import { renderGenreEditBtn } from "./ui-helpers.js?v=5.16";
import { wireProposeFoot } from "./ui-edit.js?v=5.16";
import { heatRow, heatStripHtml, heatAxisHtml, getHeatData } from "./heat-strip.js?v=5.16";
import { GENEALOGY, edgeKey, nodeColor, edgeExists } from "./genre-model.js?v=5.16";
