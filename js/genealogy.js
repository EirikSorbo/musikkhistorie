...
export const GENEALOGY = [
  ...
  { id: "vestafrik", l: "Vestafrikansk", f: "Vestafrikansk musikk", fam: "gray", cx: 300, r: 0, p: [], g: null, era: "Røtter", d: "Griot-tradisjon, work songs, call & response og rytmefokus — kjernen i nesten alt som kommer etter.", t: [] },
  ...
  { id: "spirituals", l: "Spirituals", f: "Negro spirituals", fam: "gray", cx: 440, r: 1, p: ["vestafrik"], g: null, era: "1800-tallet", d: "Religiøse sanger som blandet europeiske salmer med afrikansk uttrykk.", t: ["Swing Low (1909)", "Slave Songs of the United States (1867)"] },
  { id: "blues", l: "Blues", f: "Blues", fam: "blue", cx: 250, r: 2, p: ["worksongs"], g: "Blues", era: "ca. 1900", d: "Verdslig, individuell sang om smerte og lengsel. Grunnmuren for nesten all populærmusikk.", t: ["Cross Road Blues – Robert Johnson (1937)", "St. Louis Blues – Bessie Smith (1925)"] },
  { id: "ragtime", l: "Ragtime", f: "Ragtime", fam: "purple", cx: 410, r: 2, p: ["vestafrik"], g: "Jazz", era: "1897", d: "Komponert og notert, synkopert pianomusikk. Bindeledd mot jazzen.", t: ["Maple Leaf Rag – Scott Joplin", "The Entertainer – Scott Joplin"] },
  { id: "tinpan", l: "Tin Pan Alley", f: "Tin Pan Alley", fam: "gray", cx: 660, r: 2, p: ["eurofolk"], g: "Afroamerikansk populærmusikk", era: "1910–50", d: "Låtskriversamlebånd i New York; «the American songbook».", t: ["White Christmas – Irving Berlin (1942)", "Summertime – Gershwin (1935)"] },
  { id: "jazz", l: "Jazz", f: "Jazz", fam: "purple", cx: 470, r: 3, p: ["ragtime", "blues"], g: "Jazz", era: "ca. 1915", d: "Født i New Orleans av ragtime «played hot» + blues. Improvisasjon og swing.", t: ["Dipper Mouth Blues – King Oliver (1923)", "West End Blues – Louis Armstrong (1928)"] },
  ...
  { id: "gospel", l: "Gospel", f: "Gospel", fam: "red", cx: 640, r: 3, p: ["spirituals", "blues"], g: "Afroamerikansk populærmusikk", era: "1930-tallet", d: "Komponert kirkemusikk med blues-driv. Vugge for soul og R&B.", t: ["Precious Lord, Take My Hand – Dorsey (1932)", "Lord Don't Move the Mountain – Mahalia Jackson"] },
