...
import { escapeHtml, buildKilderList } from "./util.js?v=4.68";
import { resolveDesc, resolveDescAny, missingDesc } from "./genre-descriptions.js?v=4.68";
import { modalOpen } from "./ui-modal.js?v=4.68";
import { renderGenreEditBtn } from "./ui-helpers.js?v=4.68";
import { wireProposeFoot } from "./ui-edit.js?v=4.68";
import { heatRow, heatStripHtml, heatAxisHtml, getHeatData } from "./heat-strip.js?v=4.68";
import { GENEALOGY, edgeKey, nodeColor } from "./genre-model.js?v=4.68";
