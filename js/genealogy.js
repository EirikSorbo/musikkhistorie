...
import { escapeHtml, buildKilderList } from "./util.js?v=4.12";
import { resolveDesc, resolveDescAny, missingDesc } from "./genre-descriptions.js?v=4.12";
import { modalOpen, modalClose } from "./ui-modal.js?v=4.12";
import { renderGenreEditBtn } from "./ui-helpers.js?v=4.12";
import { heatRow, heatStripHtml, heatAxisHtml, getHeatData } from "./heat-strip.js?v=4.12";
