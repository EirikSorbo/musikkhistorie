...
import { escapeHtml, buildKilderList } from "./util.js?v=5.01";
import { resolveDesc, resolveDescAny, missingDesc } from "./genre-descriptions.js?v=5.01";
import { modalOpen } from "./ui-modal.js?v=5.01";
import { renderGenreEditBtn } from "./ui-helpers.js?v=5.01";
import { wireProposeFoot } from "./ui-edit.js?v=5.01";
import { heatRow, heatStripHtml, heatAxisHtml, getHeatData } from "./heat-strip.js?v=5.01";
import { GENEALOGY, edgeKey, nodeColor } from "./genre-model.js?v=5.01";
