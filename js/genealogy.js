...
import { escapeHtml, buildKilderList } from "./util.js?v=5.35";
import { resolveDesc, resolveDescAny, missingDesc } from "./genre-descriptions.js?v=5.35";
import { modalOpen } from "./ui-modal.js?v=5.35";
import { renderGenreEditBtn, sekt } from "./ui-helpers.js?v=5.35";
import { wireProposeFoot } from "./ui-edit.js?v=5.35";
import { heatRow, heatStripHtml, heatAxisHtml, getHeatData } from "./heat-strip.js?v=5.35";
import { GENEALOGY, edgeKey, nodeColor, edgeExists } from "./genre-model.js?v=5.35";
