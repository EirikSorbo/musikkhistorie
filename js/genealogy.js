...
import { escapeHtml, buildKilderList } from "./util.js?v=4.87";
import { resolveDesc, resolveDescAny, missingDesc } from "./genre-descriptions.js?v=4.87";
import { modalOpen } from "./ui-modal.js?v=4.87";
import { renderGenreEditBtn } from "./ui-helpers.js?v=4.87";
import { wireProposeFoot } from "./ui-edit.js?v=4.87";
import { heatRow, heatStripHtml, heatAxisHtml, getHeatData } from "./heat-strip.js?v=4.87";
import { GENEALOGY, edgeKey, nodeColor } from "./genre-model.js?v=4.87";
