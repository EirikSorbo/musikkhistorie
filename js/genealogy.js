...
import { escapeHtml, buildKilderList } from "./util.js?v=5.06";
import { resolveDesc, resolveDescAny, missingDesc } from "./genre-descriptions.js?v=5.06";
import { modalOpen } from "./ui-modal.js?v=5.06";
import { renderGenreEditBtn } from "./ui-helpers.js?v=5.06";
import { wireProposeFoot } from "./ui-edit.js?v=5.06";
import { heatRow, heatStripHtml, heatAxisHtml, getHeatData } from "./heat-strip.js?v=5.06";
import { GENEALOGY, edgeKey, nodeColor } from "./genre-model.js?v=5.06";
