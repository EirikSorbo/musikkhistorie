...
import { escapeHtml, buildKilderList } from "./util.js?v=4.09";
import { resolveDesc, resolveDescAny, missingDesc } from "./genre-descriptions.js?v=4.09";
import { modalOpen, modalClose } from "./ui-modal.js?v=4.09";
import { renderGenreEditBtn } from "./ui-helpers.js?v=4.09";
import { heatRow, heatStripHtml, heatAxisHtml, getHeatData } from "./heat-strip.js?v=4.09";
