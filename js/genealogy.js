...
import { escapeHtml, buildKilderList } from "./util.js?v=5.02";
import { resolveDesc, resolveDescAny, missingDesc } from "./genre-descriptions.js?v=5.02";
import { modalOpen } from "./ui-modal.js?v=5.02";
import { renderGenreEditBtn } from "./ui-helpers.js?v=5.02";
import { wireProposeFoot } from "./ui-edit.js?v=5.02";
import { heatRow, heatStripHtml, heatAxisHtml, getHeatData } from "./heat-strip.js?v=5.02";
import { GENEALOGY, edgeKey, nodeColor } from "./genre-model.js?v=5.02";
