...
import { ytEmbedUrl, ytMaal, ytWatchUrl, parseTid, formatTid } from "./presentasjon-modell.js?v=5.53";
import { byggVisVerdi } from "./vis-lenke.js?v=5.53";
import { modalOpen, setupModal, initModalHeaders } from "./ui-modal.js?v=5.53";
