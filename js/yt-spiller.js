...
import { ytEmbedUrl, ytMaal, ytWatchUrl, parseTid, formatTid } from "./presentasjon-modell.js?v=5.44";
import { byggVisVerdi } from "./vis-lenke.js?v=5.44";
import { modalOpen, setupModal, initModalHeaders } from "./ui-modal.js?v=5.44";
