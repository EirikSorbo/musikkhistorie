...
import { escapeHtml } from "./util.js?v=5.07";
import { ARTIST_LABELS } from "./artist-schema.js?v=5.07";
import { PROPOSABLE_KEYS } from "./proposal-fields.js?v=5.07";

const FIELD_LABELS = {
  artist: ARTIST_LABELS,
  tech: {
    name: "Navn", type: "Type", category: "Kategori", instrument: "Instrument",
    inventedYear: "Oppfunnet (år)",
    adoptedYear: "Tatt i bruk (år)",
    adoptedLabel: "Tatt i bruk (forklaring)", decade: "Tiår", description: "Beskrivelse",
    imageUrl: "Bilde-URL", imageCredit: "Bildekreditering", kilder: "Kilder",
  },
  subgenre: {
    description: "Beskrivelse", kilder: "Kilder",
    activeFrom: "Mest aktiv fra år", activeTo: "Mest aktiv til år",
    era: "Epoke med ord",
  },
  instrument: {
    body: "Sammendrag",
  ...
  "decade-society": {
    society: "Samfunnsutvikling",
    kilder: "Kilder",
  },
  "decade-tech": {
    tech: "Teknologiutvikling",
    kilder: "Kilder",
  },
};

function fieldLabelFor(entityType, key) {
