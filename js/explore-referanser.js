...
import { samleKilder } from "./kilder.js?v=5.17";
import { genreNodeById, edgeExists } from "./genre-model.js?v=5.17";
import { showEdgeInfo } from "./genealogy.js?v=5.17";
import { opts, getState, metaGroupHeadHtml, wireMetaAccordion, onMainGenreClick, sjangerOpts } from "./explore-context.js?v=5.17";
import { openTechDetail } from "./explore-tech.js?v=5.17";
import { openDecade } from "./explore-decade.js?v=5.17";
import { openHistorier } from "./explore-innhold.js?v=5.17";
