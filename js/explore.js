...
// ============================================================================
import { setupModal, initModalHeaders, modalClose, showSubsjangerInfo } from "./ui.js?v=5.66";
import { SKJUL_I_STUDENTVISNING, SKJUL_I_HUBEN } from "./feature-flags.js?v=5.66";
import { MODAL_HTML } from "./explore-modals.js?v=5.66";
import { opts, setOpts, sjangerOpts, onMainGenreClick, buildLinkCtx, showArtistsForSjanger, showArtistsForInstrument, contentChanged, genreDescsChanged } from "./explore-context.js?v=5.66";
import { openVarmekart } from "./explore-varmekart.js?v=5.66";
import { openSjangerperioder } from "./explore-sjangerperioder.js?v=5.66";
import { openTidslinje, hideTidTip } from "./explore-tidslinje.js?v=5.66";
import { openTechDetail, refreshTechDetail, openTeknologi, renderTeknologiList, refreshTeknologi } from "./explore-tech.js?v=5.66";
import { openDecadeList } from "./explore-decade.js?v=5.66";
import { openReferanser } from "./explore-referanser.js?v=5.66";
import { openSubgenreList, openUndersjangre, openSubgenreInfo } from "./explore-sjanger.js?v=5.66";
import { openStoreBildet, openAppGuide, openOmHistorie, openRotter, openHistorier, openSjangerhimmel } from "./explore-innhold.js?v=5.66";
import { openInstrumenter, openPodkaster, renderInstrumenter } from "./explore-instrument.js?v=5.66";
import { openSok, wireSok } from "./explore-search.js?v=5.66";
import { erPresentasjon } from "./presentasjon.js?v=5.66";
