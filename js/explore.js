...
// ============================================================================
import { setupModal, initModalHeaders, modalClose, showSubsjangerInfo } from "./ui.js?v=3.95";
import { showSjangerInfo } from "./genealogy.js?v=3.95";
import { MODAL_HTML } from "./explore-modals.js?v=3.95";
import { opts, setOpts, sjangerOpts, onMainGenreClick, buildLinkCtx, showArtistsForSjanger, showPlaylistForMainGenre, showArtistsForInstrument, contentChanged } from "./explore-context.js?v=3.95";
import { openVarmekart } from "./explore-varmekart.js?v=3.95";
import { openTidslinje, hideTidTip } from "./explore-tidslinje.js?v=3.95";
import { openTechDetail, refreshTechDetail, openTeknologi, renderTeknologiList } from "./explore-tech.js?v=3.95";
import { openDecadeList } from "./explore-decade.js?v=3.95";
import { openKart } from "./explore-kart.js?v=3.95";
import { openSubgenreList, openUndersjangre, openSubgenreInfo } from "./explore-sjanger.js?v=3.95";
import { openStoreBildet, openAppGuide, openOmHistorie, openRotter, openHistorier, openSjangerhimmel } from "./explore-innhold.js?v=3.95";
import { openInstrumenter, renderInstrumenter } from "./explore-instrument.js?v=3.95";
