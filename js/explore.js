...
// ============================================================================
import { setupModal, initModalHeaders, modalClose, showSubsjangerInfo } from "./ui.js?v=4.72";
import { MODAL_HTML } from "./explore-modals.js?v=4.72";
import { opts, setOpts, sjangerOpts, onMainGenreClick, buildLinkCtx, showArtistsForSjanger, showArtistsForInstrument, contentChanged, genreDescsChanged } from "./explore-context.js?v=4.72";
import { openVarmekart } from "./explore-varmekart.js?v=4.72";
import { openTidslinje, hideTidTip } from "./explore-tidslinje.js?v=4.72";
import { openTechDetail, refreshTechDetail, openTeknologi, renderTeknologiList } from "./explore-tech.js?v=4.72";
import { openDecadeList } from "./explore-decade.js?v=4.72";
import { openReferanser } from "./explore-referanser.js?v=4.72";
import { openSubgenreList, openUndersjangre, openSubgenreInfo } from "./explore-sjanger.js?v=4.72";
import { openStoreBildet, openAppGuide, openOmHistorie, openRotter, openHistorier, openSjangerhimmel } from "./explore-innhold.js?v=4.72";
import { openInstrumenter, renderInstrumenter } from "./explore-instrument.js?v=4.72";
