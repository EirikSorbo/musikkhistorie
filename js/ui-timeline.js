...
import { escapeHtml } from "./util.js?v=4.10";
import { extractBullets, formatInfoText } from "./ui-helpers.js?v=4.10";
import { DECADES } from "./limits.js?v=4.10";
import { GENEALOGY, META_GENRE_COLOR, FAMILIES } from "./genealogy.js?v=4.10";
import { isHendelse } from "./ui-tech.js?v=4.10";
