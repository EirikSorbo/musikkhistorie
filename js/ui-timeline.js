...
import { extractBullets, formatInfoText } from "./ui-helpers.js?v=4.61";
import { DECADES } from "./limits.js?v=4.61";
import { GENEALOGY, META_GENRE_COLOR, FAMILIES } from "./genre-model.js?v=4.61";
import { isHendelse } from "./ui-tech.js?v=4.61";
