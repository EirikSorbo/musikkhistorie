...
import { escapeHtml } from "./util.js?v=3.93";
import { extractBullets, formatInfoText } from "./ui-helpers.js?v=3.93";
import { DECADES } from "./limits.js?v=3.93";
import { GENEALOGY, META_GENRE_COLOR, FAMILIES } from "./genealogy.js?v=3.93";
import { isHendelse } from "./ui-tech.js?v=3.93";
