...
import { escapeHtml } from "./util.js?v=4.02";
import { extractBullets, formatInfoText } from "./ui-helpers.js?v=4.02";
import { DECADES } from "./limits.js?v=4.02";
import { GENEALOGY, META_GENRE_COLOR, FAMILIES } from "./genealogy.js?v=4.02";
import { isHendelse } from "./ui-tech.js?v=4.02";
