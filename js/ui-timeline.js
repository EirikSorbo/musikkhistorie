...
import { escapeHtml } from "./util.js?v=3.85";
import { extractBullets, formatInfoText } from "./ui-helpers.js?v=3.85";
import { DECADES } from "./limits.js?v=3.85";
import { GENEALOGY, META_GENRE_COLOR, FAMILIES } from "./genealogy.js?v=3.85";
import { isHendelse } from "./ui-tech.js?v=3.85";
