...
import { formatInfoText } from "./ui-helpers.js?v=5.24";
import { DECADES } from "./limits.js?v=5.24";
import { GENEALOGY } from "./genre-model.js?v=5.24";
...
import { resolveDescAny } from "./genre-descriptions.js?v=5.24";
import { isHendelse } from "./ui-tech.js?v=5.24";
