...
import { formatInfoText } from "./ui-helpers.js?v=5.12";
import { DECADES } from "./limits.js?v=5.12";
import { GENEALOGY, META_GENRE_COLOR, FAMILIES } from "./genre-model.js?v=5.12";
...
import { resolveDescAny } from "./genre-descriptions.js?v=5.12";
import { isHendelse } from "./ui-tech.js?v=5.12";
