...
// ============================================================================
import { modalOpen, escapeHtml } from "./ui.js?v=5.52";
import { isVisible } from "./limits.js?v=5.52";
import { META_GENRE_COLOR, FAMILIES, GENEALOGY_ROOT_GENRES, MAIN_GENRE_INFO } from "./genre-model.js?v=5.52";
import { pageFor, storyFor, stripGenrePath, storyOrder } from "./story-format.js?v=5.52";
import { renderRichText } from "./rich-text.js?v=5.52";
import { genreFamilyNodes } from "./ui-timeline.js?v=5.52";
import { heatBlockHtml, heatAxisRowHtml, heatRowsHtml, wireHeatRows } from "./heat-rows.js?v=5.52";
import { wireLinks } from "./ui-helpers.js?v=5.52";
import { renderSjangerhimmel } from "./constellation.js?v=5.52";
import { opts, getState, buildLinkCtx, injectTeacherRow, onMainGenreClick } from "./explore-context.js?v=5.52";
